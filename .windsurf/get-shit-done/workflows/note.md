...
- **Global scope**: `C:/Users/atacc/Desktop/kalasetu/.windsurf/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/atacc/Desktop/kalasetu/.windsurf/notes/`)
...
2. Glob `C:/Users/atacc/Desktop/kalasetu/.windsurf/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/atacc/Desktop/kalasetu/.windsurf/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/atacc/Desktop/kalasetu/.windsurf/notes/` — works in any directory
