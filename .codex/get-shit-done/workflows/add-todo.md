...
```bash
INIT=$(node "C:/Users/atacc/Desktop/kalasetu/.codex/get-shit-done/bin/gsd-tools.cjs" init todos)
...
```bash
slug=$(node "C:/Users/atacc/Desktop/kalasetu/.codex/get-shit-done/bin/gsd-tools.cjs" generate-slug "$title" --raw)
```
...
```bash
node "C:/Users/atacc/Desktop/kalasetu/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture todo - [title]" --files .planning/todos/pending/[filename] .planning/STATE.md
```
